...
public class TenPayController extends BaseController{
   ...
   private final static Logger logger = LoggerFactory.getLogger(Utils.class);
     ...
     * @throws IOException
     */
    @RequestMapping(value = "/app/tenpay/notify", method = RequestMethod.POST)
    @ApiOperation(value="微信支付通知接口")
    ...
    public String returMoney(HttpServletRequest request,WxRefund wxRefund,HttpServletResponse response) throws UnsupportedEncodingException {
        //根据订单号查出金额和积分
        String  refund=weixinService.refund(wxRefund,request,response);
        return refund;
